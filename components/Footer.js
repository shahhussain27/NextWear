        ...
        <div className="flex-grow flex flex-wrap md:pl-20 -mb-10 md:mt-0 mt-10 md:text-left text-center">
          <div className="lg:w-1/4 md:w-1/2 w-full px-4">
            ...
            <nav className="list-none mb-10">
              <li>
                <a className="text-black">T-Shirts</a>
              </li>
              <li>
                <a className="text-black">Sweatshirts</a>
              </li>
              <li>
                <a className="text-black">Hoodies</a>
              </li>
              <li>
                <a className="text-black">Mugs</a>
              </li>
            </nav>
          </div>
          <div className="lg:w-1/4 md:w-1/2 w-full px-4">
            ...
            <nav className="list-none mb-10">
              ...
              <li>
                <a className="text-black">Return Policy</a>
              </li>
              <li>
                <a className="text-black">Shipping Policy</a>
              </li>
            </nav>
          </div>
          <div className="lg:w-1/4 md:w-1/2 w-full px-4">
            ...
            <nav className="list-none mb-10">
              ...
              <li>
                <a className="text-black">Terms and Conditions</a>
              </li>
            </nav>
          </div>
        </div>
      ...
      <div className="bg-gray-800 bg-opacity-75">
        <div className="container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row">
          <p className="text-gray-200 text-sm text-center sm:text-left">
            © 2024 NextWear —
            <a rel="noopener noreferrer" className="text-white ml-1">
              @shah_hussain27
            </a>
          </p>
