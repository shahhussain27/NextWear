    ...
    <section className="text-gray-600 body-font overflow-hidden">
      <div className="container px-5 py-16 mx-auto">
        <div className="lg:w-3/5 mx-auto flex flex-wrap">
          <Image
            alt={product.img}
            className="lg:w-1/2 w-full lg:h-auto px-34 object-cover object-center rounded"
            src={product.img}
            height={100}
            width={100}
          />
          <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                ...
                {color && Object.keys(variants).includes("Red") &&
                  Object.keys(variants["Red"]).includes(size) && (
                    <button
                      ...
                      className={`border-2  ml-1 bg-rose-500 rounded-full w-6 h-6 focus:outline-none ${
            ...
            <div className="flex flex-col gap-2 mb-5">
              <div className="flex gap-2">
                <input
                  className="border-2 border-blue-600 rounded py-1.5 px-2 text-lg w-full"
                  type="text"
